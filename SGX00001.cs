...
namespace CenasiAPP
{
  public class SGX00001 : Page
  {
    ...
    protected HtmlInputText txtArgumento;
    ...
    private string ARGUMENTO
    {
      get
      {
        return this.txtArgumento.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      ((Site1) this.Master)._ValidaAccesoPagina(this.xBase + ".aspx");
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.cmbFormularios.Value = dataRow["OPCIONURL"].ToString().ToUpper();
        this.txtOrden.Value = dataRow["OPCIONORDEN"].ToString();
        this.txtArgumento.Value = dataRow["ARGUMENTO"].ToString();
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@ARGUMENTO");
      this.xQueryValues.Add((object) this.ARGUMENTO);
