<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.cs" Inherits="CenasiAPP.login" %>
...
<body class='login theme-satblue' runat="server">
    <div class="wrapper">
        <h1>
            <a href="index.html">
                <img src="img/logo-big.png" alt="" class='retina-ready' width="59" height="49">SIGES</a></h1>
        <div class="login-body">
            ...
            <br />
                <div class="control-group">
                <label id="lblSrvr" runat="server">
                </label>
            </div>

            </form>
            <div class="forget">
                <a href="forget.aspx"><span>¿Olvidó su contraseña?</span></a>
            </div>
        </div>
    </div>
</body>
